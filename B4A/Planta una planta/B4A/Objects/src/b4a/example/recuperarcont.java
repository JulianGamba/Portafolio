...
public class recuperarcont extends Activity implements B4AActivity{
	public static recuperarcont mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.recuperarcont");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (recuperarcont).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.recuperarcont");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.recuperarcont", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (recuperarcont) Create " + (isFirst ? "(first time)" : "") + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (recuperarcont) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        if (!dontPause)
            BA.LogInfo("** Activity (recuperarcont) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        else
            BA.LogInfo("** Activity (recuperarcont) Pause event (activity is not paused). **");
        if (mostCurrent != null)
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 22;BA.debugLine="Activity.LoadLayout(\"recuperarCont\")";
mostCurrent._activity.LoadLayout("recuperarCont",mostCurrent.activityBA);
...
public static String  _button1_click() throws Exception{
 //BA.debugLineNum = 35;BA.debugLine="Private Sub Button1_Click";
 //BA.debugLineNum = 36;BA.debugLine="StartActivity(\"nuevaCont\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("nuevaCont"));

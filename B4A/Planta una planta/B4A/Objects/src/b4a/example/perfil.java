...
public class perfil extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.perfil");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.perfil");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.perfil", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (perfil) Create " + (isFirst ? "(first time)" : "") + " **");
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        if (!dontPause)
            ...
            BA.LogInfo("** Activity (perfil) Pause event (activity is not paused). **");
        if (mostCurrent != null)
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 25;BA.debugLine="Activity.LoadLayout(\"perfil\")";
mostCurrent._activity.LoadLayout("perfil",mostCurrent.activityBA);
...
public static String  _button1_click() throws Exception{
 ...
 //BA.debugLineNum = 54;BA.debugLine="StartActivity(\"ingresardatos\")";
...
public static String  _imageview1_click() throws Exception{
 //BA.debugLineNum = 45;BA.debugLine="Private Sub ImageView1_Click";
 //BA.debugLineNum = 46;BA.debugLine="StartActivity(\"landingPage\")";
...
public static String  _imageview3_click() throws Exception{
 //BA.debugLineNum = 37;BA.debugLine="Private Sub ImageView3_Click";
 //BA.debugLineNum = 39;BA.debugLine="End Sub";
return "";
}
public static String  _imageview4_click() throws Exception{
 //BA.debugLineNum = 41;BA.debugLine="Private Sub ImageView4_Click";

...
public class plantas extends Activity implements B4AActivity{
	public static plantas mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.plantas");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (plantas).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.plantas");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.plantas", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (plantas) Create " + (isFirst ? "(first time)" : "") + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (plantas) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        if (!dontPause)
            BA.LogInfo("** Activity (plantas) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        else
            BA.LogInfo("** Activity (plantas) Pause event (activity is not paused). **");
        if (mostCurrent != null)
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 31;BA.debugLine="Activity.LoadLayout(\"plantas\")";
mostCurrent._activity.LoadLayout("plantas",mostCurrent.activityBA);
 //BA.debugLineNum = 33;BA.debugLine="ScrollView1.Panel.LoadLayout(\"tropicales\")";
mostCurrent._scrollview1.getPanel().LoadLayout("tropicales",mostCurrent.activityBA);
...
mostCurrent._label1 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 22;BA.debugLine="Private ImageView7 As ImageView";
...
public static String  _imageview1_click() throws Exception{
 //BA.debugLineNum = 50;BA.debugLine="Private Sub ImageView1_Click";
...
public static String  _imageview3_click() throws Exception{
 //BA.debugLineNum = 46;BA.debugLine="Private Sub ImageView3_Click";
 //BA.debugLineNum = 47;BA.debugLine="StartActivity(\"perfil\")";
...
public static String  _imageview4_click() throws Exception{
 //BA.debugLineNum = 54;BA.debugLine="Private Sub ImageView4_Click";
 //BA.debugLineNum = 55;BA.debugLine="StartActivity(\"LandingPage\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("LandingPage"));
 //BA.debugLineNum = 56;BA.debugLine="End Sub";
return "";
}
public static String  _imageview6_click() throws Exception{
 //BA.debugLineNum = 58;BA.debugLine="Private Sub ImageView6_Click";
 //BA.debugLineNum = 59;BA.debugLine="StartActivity(\"plantas2\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("plantas2"));
 //BA.debugLineNum = 60;BA.debugLine="End Sub";
return "";
}
public static String  _imageview7_click() throws Exception{
 //BA.debugLineNum = 66;BA.debugLine="Private Sub ImageView7_Click";
 //BA.debugLineNum = 67;BA.debugLine="StartActivity(\"coco\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("coco"));
 //BA.debugLineNum = 68;BA.debugLine="End Sub";
return "";
}
public static String  _imageview8_click() throws Exception{
 //BA.debugLineNum = 70;BA.debugLine="Private Sub ImageView8_Click";
 //BA.debugLineNum = 71;BA.debugLine="StartActivity(\"bambu\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("bambu"));
 //BA.debugLineNum = 72;BA.debugLine="End Sub";
return "";
}
public static String  _imageview9_click() throws Exception{
 //BA.debugLineNum = 78;BA.debugLine="Private Sub ImageView9_Click";
 //BA.debugLineNum = 79;BA.debugLine="StartActivity(\"jengibre\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("jengibre"));
 //BA.debugLineNum = 80;BA.debugLine="End Sub";
return "";
}
public static String  _label1_click() throws Exception{
 //BA.debugLineNum = 62;BA.debugLine="Private Sub Label1_Click";
 //BA.debugLineNum = 63;BA.debugLine="StartActivity(\"coco\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("coco"));
...
public static String  _label2_click() throws Exception{
 ...
 //BA.debugLineNum = 75;BA.debugLine="StartActivity(\"bambu\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("bambu"));
 //BA.debugLineNum = 76;BA.debugLine="End Sub";
return "";
}
public static String  _label3_click() throws Exception{
 //BA.debugLineNum = 82;BA.debugLine="Private Sub Label3_Click";
 //BA.debugLineNum = 83;BA.debugLine="StartActivity(\"jengibre\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("jengibre"));

...
public class landing1 extends Activity implements B4AActivity{
	public static landing1 mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.landing1");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (landing1).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.landing1");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.landing1", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (landing1) Create " + (isFirst ? "(first time)" : "") + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (landing1) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        if (!dontPause)
            BA.LogInfo("** Activity (landing1) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        else
            BA.LogInfo("** Activity (landing1) Pause event (activity is not paused). **");
        if (mostCurrent != null)
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 22;BA.debugLine="Activity.LoadLayout(\"landing1\")";
mostCurrent._activity.LoadLayout("landing1",mostCurrent.activityBA);
...
public static String  _button1_click() throws Exception{
 ...
 //BA.debugLineNum = 41;BA.debugLine="StartActivity(\"registro\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("registro"));
 //BA.debugLineNum = 42;BA.debugLine="End Sub";
return "";
}
public static String  _button2_click() throws Exception{
 //BA.debugLineNum = 36;BA.debugLine="Private Sub Button2_Click";
 //BA.debugLineNum = 37;BA.debugLine="StartActivity(\"iniciaSesion\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("iniciaSesion"));

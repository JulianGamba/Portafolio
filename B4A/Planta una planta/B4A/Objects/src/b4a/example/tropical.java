...
public class tropical extends Activity implements B4AActivity{
	public static tropical mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.tropical");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (tropical).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.tropical");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.tropical", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (tropical) Create " + (isFirst ? "(first time)" : "") + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (tropical) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        if (!dontPause)
            BA.LogInfo("** Activity (tropical) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        else
            BA.LogInfo("** Activity (tropical) Pause event (activity is not paused). **");
        if (mostCurrent != null)
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 23;BA.debugLine="Activity.LoadLayout(\"tropical\")";
mostCurrent._activity.LoadLayout("tropical",mostCurrent.activityBA);
...
public static String  _imageview1_click() throws Exception{
 //BA.debugLineNum = 40;BA.debugLine="Private Sub ImageView1_Click";
 //BA.debugLineNum = 41;BA.debugLine="StartActivity(\"landingpage\")";
...
public static String  _imageview3_click() throws Exception{
 //BA.debugLineNum = 44;BA.debugLine="Private Sub ImageView3_Click";
 //BA.debugLineNum = 45;BA.debugLine="StartActivity(\"perfil\")";
...
public static String  _imageview4_click() throws Exception{
 //BA.debugLineNum = 36;BA.debugLine="Private Sub ImageView4_Click";
 //BA.debugLineNum = 37;BA.debugLine="StartActivity(\"recomendaciones\")";

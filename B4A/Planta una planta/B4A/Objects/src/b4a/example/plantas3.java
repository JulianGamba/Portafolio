...
public class plantas3 extends Activity implements B4AActivity{
	public static plantas3 mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.plantas3");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (plantas3).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.plantas3");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.plantas3", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (plantas3) Create " + (isFirst ? "(first time)" : "") + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (plantas3) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        if (!dontPause)
            BA.LogInfo("** Activity (plantas3) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        else
            BA.LogInfo("** Activity (plantas3) Pause event (activity is not paused). **");
        if (mostCurrent != null)
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 30;BA.debugLine="Activity.LoadLayout(\"plantas3\")";
mostCurrent._activity.LoadLayout("plantas3",mostCurrent.activityBA);
 //BA.debugLineNum = 32;BA.debugLine="ScrollView1.Panel.LoadLayout(\"templadas\")";
mostCurrent._scrollview1.getPanel().LoadLayout("templadas",mostCurrent.activityBA);
 //BA.debugLineNum = 33;BA.debugLine="ScrollView1.Panel.Width=363dip";
mostCurrent._scrollview1.getPanel().setWidth(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (363)));
 //BA.debugLineNum = 34;BA.debugLine="ScrollView1.Panel.Height=770dip";
...
mostCurrent._label3 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 23;BA.debugLine="Private ImageView7 As ImageView";
mostCurrent._imageview7 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 24;BA.debugLine="Private ImageView8 As ImageView";
...
public static String  _imageview1_click() throws Exception{
 //BA.debugLineNum = 49;BA.debugLine="Private Sub ImageView1_Click";
 //BA.debugLineNum = 50;BA.debugLine="StartActivity(\"landingpage\")";
...
public static String  _imageview3_click() throws Exception{
 //BA.debugLineNum = 53;BA.debugLine="Private Sub ImageView3_Click";
 //BA.debugLineNum = 54;BA.debugLine="StartActivity(\"perfil\")";
...
public static String  _imageview4_click() throws Exception{
 //BA.debugLineNum = 45;BA.debugLine="Private Sub ImageView4_Click";
 //BA.debugLineNum = 46;BA.debugLine="StartActivity(\"plantas2\")";
...
public static String  _imageview7_click() throws Exception{
 //BA.debugLineNum = 65;BA.debugLine="Private Sub ImageView7_Click";
 //BA.debugLineNum = 66;BA.debugLine="StartActivity(\"fresno\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("fresno"));
 //BA.debugLineNum = 67;BA.debugLine="End Sub";
return "";
}
public static String  _imageview8_click() throws Exception{
 //BA.debugLineNum = 69;BA.debugLine="Private Sub ImageView8_Click";
 //BA.debugLineNum = 70;BA.debugLine="StartActivity(\"lavanda\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("lavanda"));
 //BA.debugLineNum = 71;BA.debugLine="End Sub";
return "";
}
public static String  _imageview9_click() throws Exception{
 //BA.debugLineNum = 77;BA.debugLine="Private Sub ImageView9_Click";
 //BA.debugLineNum = 78;BA.debugLine="StartActivity(\"tomate\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("tomate"));
 //BA.debugLineNum = 79;BA.debugLine="End Sub";
return "";
}
public static String  _label1_click() throws Exception{
 //BA.debugLineNum = 61;BA.debugLine="Private Sub Label1_Click";
 //BA.debugLineNum = 62;BA.debugLine="StartActivity(\"fresno\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("fresno"));
...
public static String  _label2_click() throws Exception{
 ...
 //BA.debugLineNum = 74;BA.debugLine="StartActivity(\"lavanda\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("lavanda"));
 //BA.debugLineNum = 75;BA.debugLine="End Sub";
return "";
}
public static String  _label3_click() throws Exception{
 //BA.debugLineNum = 81;BA.debugLine="Private Sub Label3_Click";
 //BA.debugLineNum = 82;BA.debugLine="StartActivity(\"tomate\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("tomate"));

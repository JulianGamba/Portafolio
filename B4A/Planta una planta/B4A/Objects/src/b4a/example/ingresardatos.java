...
public class ingresardatos extends Activity implements B4AActivity{
	public static ingresardatos mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.ingresardatos");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (ingresardatos).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.ingresardatos");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.ingresardatos", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (ingresardatos) Create " + (isFirst ? "(first time)" : "") + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (ingresardatos) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        if (!dontPause)
            BA.LogInfo("** Activity (ingresardatos) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        else
            BA.LogInfo("** Activity (ingresardatos) Pause event (activity is not paused). **");
        if (mostCurrent != null)
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 24;BA.debugLine="Activity.LoadLayout(\"ingresardatos\")";
mostCurrent._activity.LoadLayout("ingresardatos",mostCurrent.activityBA);
...
public static String  _button1_click() throws Exception{
 ...
 //BA.debugLineNum = 50;BA.debugLine="StartActivity(\"resultadosdatos\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("resultadosdatos"));
...
public static String  _imageview1_click() throws Exception{
 //BA.debugLineNum = 41;BA.debugLine="Private Sub ImageView1_Click";
 //BA.debugLineNum = 42;BA.debugLine="StartActivity(\"landingpage\")";
...
public static String  _imageview3_click() throws Exception{
 //BA.debugLineNum = 45;BA.debugLine="Private Sub ImageView3_Click";
 //BA.debugLineNum = 46;BA.debugLine="StartActivity(\"perfil	\")";
...
public static String  _imageview4_click() throws Exception{
 //BA.debugLineNum = 37;BA.debugLine="Private Sub ImageView4_Click";
 //BA.debugLineNum = 38;BA.debugLine="StartActivity(\"landingpage\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("landingpage"));

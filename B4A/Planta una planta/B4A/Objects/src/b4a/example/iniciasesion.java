...
public class iniciasesion extends Activity implements B4AActivity{
	public static iniciasesion mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.iniciasesion");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (iniciasesion).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.iniciasesion");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.iniciasesion", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (iniciasesion) Create " + (isFirst ? "(first time)" : "") + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (iniciasesion) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        if (!dontPause)
            BA.LogInfo("** Activity (iniciasesion) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        else
            BA.LogInfo("** Activity (iniciasesion) Pause event (activity is not paused). **");
        if (mostCurrent != null)
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 25;BA.debugLine="Activity.LoadLayout(\"iniciaSesion\")";
mostCurrent._activity.LoadLayout("iniciaSesion",mostCurrent.activityBA);
...
public static String  _label2_click() throws Exception{
 //BA.debugLineNum = 46;BA.debugLine="Private Sub Label2_Click";
 //BA.debugLineNum = 47;BA.debugLine="StartActivity(\"recuperarCont\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("recuperarCont"));
 //BA.debugLineNum = 48;BA.debugLine="End Sub";
return "";
}
public static String  _label3_click() throws Exception{
 //BA.debugLineNum = 42;BA.debugLine="Private Sub Label3_Click";
 //BA.debugLineNum = 43;BA.debugLine="StartActivity(\"registro\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("registro"));

...
public class landingpage extends Activity implements B4AActivity{
	public static landingpage mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.landingpage");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (landingpage).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.landingpage");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.landingpage", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (landingpage) Create " + (isFirst ? "(first time)" : "") + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (landingpage) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        if (!dontPause)
            BA.LogInfo("** Activity (landingpage) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        else
            BA.LogInfo("** Activity (landingpage) Pause event (activity is not paused). **");
        if (mostCurrent != null)
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 25;BA.debugLine="Activity.LoadLayout(\"landingPage\")";
...
public static String  _button1_click() throws Exception{
 ...
 //BA.debugLineNum = 43;BA.debugLine="StartActivity(\"plantas\")";
...
public static String  _button2_click() throws Exception{
 ...
 //BA.debugLineNum = 47;BA.debugLine="StartActivity(\"recomendaciones\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("recomendaciones"));
 //BA.debugLineNum = 48;BA.debugLine="End Sub";
return "";
}
public static String  _button3_click() throws Exception{
 //BA.debugLineNum = 50;BA.debugLine="Private Sub Button3_Click";
 //BA.debugLineNum = 51;BA.debugLine="StartActivity(\"ingresardatos\")";
...
public static String  _imageview3_click() throws Exception{
 //BA.debugLineNum = 38;BA.debugLine="Private Sub ImageView3_Click";
 //BA.debugLineNum = 39;BA.debugLine="StartActivity(\"perfil\")";

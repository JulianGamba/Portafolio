...
public class aloevera extends Activity implements B4AActivity{
	public static aloevera mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.aloevera");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (aloevera).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.aloevera");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.aloevera", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (aloevera) Create " + (isFirst ? "(first time)" : "") + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (aloevera) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        if (!dontPause)
            BA.LogInfo("** Activity (aloevera) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        else
            BA.LogInfo("** Activity (aloevera) Pause event (activity is not paused). **");
        if (mostCurrent != null)
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 23;BA.debugLine="Activity.LoadLayout(\"aloevera\")";
mostCurrent._activity.LoadLayout("aloevera",mostCurrent.activityBA);
...
public static String  _imageview1_click() throws Exception{
 //BA.debugLineNum = 39;BA.debugLine="Private Sub ImageView1_Click";
 //BA.debugLineNum = 40;BA.debugLine="StartActivity(\"LandingPage\")";
...
public static String  _imageview3_click() throws Exception{
 //BA.debugLineNum = 35;BA.debugLine="Private Sub ImageView3_Click";
 //BA.debugLineNum = 36;BA.debugLine="StartActivity(\"perfil\")";
...
public static String  _imageview4_click() throws Exception{
 //BA.debugLineNum = 43;BA.debugLine="Private Sub ImageView4_Click";
 //BA.debugLineNum = 44;BA.debugLine="StartActivity(\"plantas2\")";

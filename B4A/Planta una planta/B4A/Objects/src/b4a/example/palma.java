...
public class palma extends Activity implements B4AActivity{
	public static palma mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.palma");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (palma).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.palma");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.palma", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (palma) Create " + (isFirst ? "(first time)" : "") + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (palma) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        if (!dontPause)
            BA.LogInfo("** Activity (palma) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        else
            BA.LogInfo("** Activity (palma) Pause event (activity is not paused). **");
        if (mostCurrent != null)
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 20;BA.debugLine="Activity.LoadLayout(\"palma\")";
mostCurrent._activity.LoadLayout("palma",mostCurrent.activityBA);
...
public static String  _imageview3_click() throws Exception{
 //BA.debugLineNum = 32;BA.debugLine="Private Sub ImageView3_Click";
 //BA.debugLineNum = 33;BA.debugLine="StartActivity(\"perfil\")";
...
public static String  _imageview4_click() throws Exception{
 //BA.debugLineNum = 40;BA.debugLine="Private Sub ImageView4_Click";
 //BA.debugLineNum = 41;BA.debugLine="StartActivity(\"plantas2\")";

...
public class contenidoconsejos extends Activity implements B4AActivity{
	public static contenidoconsejos mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.contenidoconsejos");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (contenidoconsejos).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.contenidoconsejos");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.contenidoconsejos", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (contenidoconsejos) Create " + (isFirst ? "(first time)" : "") + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (contenidoconsejos) Resume **");
...
@Override
 ...
 protected void onStop() {
    ...
    public static Class<?> getObject() {
		return contenidoconsejos.class;
	}
	...
	public void onPause() {
        ...
        if (!dontPause)
            BA.LogInfo("** Activity (contenidoconsejos) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        else
            BA.LogInfo("** Activity (contenidoconsejos) Pause event (activity is not paused). **");
        if (mostCurrent != null)
    ...
    private static class ResumeMessage implements Runnable {
		...
		public void run() {
            contenidoconsejos mc = mostCurrent;
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 24;BA.debugLine="Activity.LoadLayout(\"contenidoconsejos\")";
mostCurrent._activity.LoadLayout("contenidoconsejos",mostCurrent.activityBA);
...
public static String  _globals() throws Exception{
 ...
 //BA.debugLineNum = 16;BA.debugLine="Private ImageView5 As ImageView";
...
mostCurrent._label2 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 18;BA.debugLine="Private ImageView6 As ImageView";
...
public static String  _imageview5_click() throws Exception{
 //BA.debugLineNum = 41;BA.debugLine="Private Sub ImageView5_Click";
 //BA.debugLineNum = 42;BA.debugLine="StartActivity(\"tropical\")";
...
public static String  _imageview6_click() throws Exception{
 //BA.debugLineNum = 45;BA.debugLine="Private Sub ImageView6_Click";
 //BA.debugLineNum = 46;BA.debugLine="StartActivity(\"desertico\")";
...
public static String  _label2_click() throws Exception{
 //BA.debugLineNum = 37;BA.debugLine="Private Sub Label2_Click";
 //BA.debugLineNum = 38;BA.debugLine="StartActivity(\"tropical\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("tropical"));
 //BA.debugLineNum = 39;BA.debugLine="End Sub";
return "";
}
public static String  _label3_click() throws Exception{
 //BA.debugLineNum = 49;BA.debugLine="Private Sub Label3_Click";
 //BA.debugLineNum = 50;BA.debugLine="StartActivity(\"desertico\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("desertico"));

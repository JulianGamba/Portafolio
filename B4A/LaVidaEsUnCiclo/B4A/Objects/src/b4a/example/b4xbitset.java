...
_vvvvvv4 = new int[(int) (__c.Bit.ShiftRight(_vvvvvv5,(int) (5))+1)];
;
 //BA.debugLineNum = 60;BA.debugLine="End Sub";
return "";
}
public boolean  _vvvvv0(int _index) throws Exception{
int _dindex = 0;
int _offset = 0;
int _blockvalue = 0;
...
public String  _vvvvvv2(int _index,boolean _value) throws Exception{
int _dindex = 0;
int _offset = 0;
int _blockvalue = 0;
...
_vvvvvv4[_dindex] = _newblockvalue;

...
public int  _vvvvvvvvvv5(anywheresoftware.b4a.objects.collections.List _data,int _startindex,int _length,int _pivotindex,Object _comparator) throws Exception{
...
_vvvvvvvvvv0(_data,_startindex,_pivotindex,(int) (_length-1));
...
_vvvvvvvvvv0(_data,_startindex,(int) (_l-1),_i);
 };
 }
};
 //BA.debugLineNum = 40;BA.debugLine="Swap(Data, StartIndex, Length - 1, L)";
_vvvvvvvvvv0(_data,_startindex,(int) (_length-1),_l);
 //BA.debugLineNum = 41;BA.debugLine="Return L";
if (true) return _l;
 //BA.debugLineNum = 42;BA.debugLine="End Sub";
return 0;
}
public String  _vvvvvvvvvv6(anywheresoftware.b4a.objects.collections.List _data,int _startindex,int _length,Object _comparator) throws Exception{
int _pivotindex = 0;
int _r = 0;
...
_r = _vvvvvvvvvv5(_data,_startindex,_length,_pivotindex,_comparator);
 //BA.debugLineNum = 25;BA.debugLine="QuickSort(Data, StartIndex, r, Comparator)";
_vvvvvvvvvv6(_data,_startindex,_r,_comparator);
 //BA.debugLineNum = 26;BA.debugLine="QuickSort(Data, StartIndex + r + 1, Length - r -";
_vvvvvvvvvv6(_data,(int) (_startindex+_r+1),(int) (_length-_r-1),_comparator);
 };
 //BA.debugLineNum = 28;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvv7(anywheresoftware.b4a.objects.collections.List _data,Object _comparator) throws Exception{
...
_vvvvvvvvvv6(_data,(int) (0),_data.getSize(),_comparator);
 //BA.debugLineNum = 18;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvv0(anywheresoftware.b4a.objects.collections.List _data,int _startindex,int _i1,int _i2) throws Exception{
Object _o = null;

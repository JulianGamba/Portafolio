...
public b4a.example.b4xorderedmap _vvvvvvvvvvvvvvv2 = null;
public b4a.example.b4xorderedmap _vvvvvvvvvvvvvvv3 = null;
public anywheresoftware.b4j.object.JavaObject _vvvvvvvvvvvvvvv4 = null;
public b4a.example.b4xset _vvvvvvvvvvvvvvv5 = null;
public anywheresoftware.b4a.objects.B4XViewWrapper.XUI _vvvv4 = null;
public anywheresoftware.b4a.objects.ActivityWrapper _vvvvvvvvvvvvvvv6 = null;
...
_vvvvvvvvvvvvvv4(_vvvvvvvvvvvvv0(),"B4XPage_Disappear",(Object[])(__c.Null));
 //BA.debugLineNum = 637;BA.debugLine="BackgroundStateChanged(False)";
_vvvvvvvvvvvv4(__c.False);
...
_shouldraise = _vvvvvvvvvvvvvvvv1==__c.False;
 //BA.debugLineNum = 612;BA.debugLine="BackgroundStateChanged(True)";
_vvvvvvvvvvvv4(__c.True);
...
_vvvvvvvvvvvvvv3(_vvvvvvvvvvvvv0(),"B4XPage_Appear",(Object[])(__c.Null));
 };
...
_vvvvvvvvvvvvv5(_b4xpage).Parent /*b4a.example.b4xpagesmanager._b4xpageparent*/ .MenuItems /*anywheresoftware.b4a.objects.collections.List*/ .Add((Object)(_mi));
...
if (_vvvvvvvvvvvvvvv2._vvvvvvvv7 /*boolean*/ ((Object)(_idtolower))) { 
...
_vvvvvvvvvvvvvvv2._vvvvvvvvv4 /*String*/ ((Object)(_idtolower),(Object)(_vvvvvvvvvvvv0(_b4xpage,_idtolower,__c.False,(Object)(_id))));
 //BA.debugLineNum = 148;BA.debugLine="If IdToB4XPage.Size = 1 Then ShowPage(IdToLower)";
if (_vvvvvvvvvvvvvvv2._getvvvvvv3 /*int*/ ()==1) { 
_vvv3(_idtolower);};
...
_vvvvvvvvvvvvv3(_vvvvvvvvvvvvv6(_id));
 //BA.debugLineNum = 154;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvv4(boolean _newstate) throws Exception{
String _ev = "";
b4a.example.b4xpagesmanager._b4xpageinfo _pi = null;
...
if (_vvvvvvvvvvvvvvvv1==_newstate) { 
if (true) return "";};
 //BA.debugLineNum = 620;BA.debugLine="IsForeground = NewState";
_vvvvvvvvvvvvvvvv1 = _newstate;
...
if (_vvvvvvvvvvvvvvvv1) { 
_ev = "B4XPage_Foreground";}
else {
_ev = "B4XPage_Background";};
 //BA.debugLineNum = 623;BA.debugLine="For Each pi As B4XPageInfo In IdToB4XPage.Values";
{
final anywheresoftware.b4a.BA.IterableList group5 = _vvvvvvvvvvvvvvv2._getvvvvvvvvvvv6 /*anywheresoftware.b4a.objects.collections.List*/ ();
...
_vvvvvvvvvvvvvvv0 = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(_jo.RunMethod("getActionBar",(Object[])(__c.Null))));
 //BA.debugLineNum = 102;BA.debugLine="If ActionBar.IsInitialized = False Then";
if (_vvvvvvvvvvvvvvv0.IsInitialized()==__c.False) { 
...
_vvvvvvvvvvvvvvv0 = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(_jo.RunMethod("getSupportActionBar",(Object[])(__c.Null))));
 };
 };
...
__c.LogImpl("97798805","#SupportedOrientations attribute must be set to landscape or portrait.",_vvvv4.Color_Red);
 };
 };
 }
};
...
_vvvvvvvvvvvvvvv2 = new b4a.example.b4xorderedmap();
 //BA.debugLineNum = 24;BA.debugLine="Private RootB4XToPage As B4XOrderedMap";
_vvvvvvvvvvvvvvv3 = new b4a.example.b4xorderedmap();
 //BA.debugLineNum = 26;BA.debugLine="Private Context As JavaObject";
_vvvvvvvvvvvvvvv4 = new anywheresoftware.b4j.object.JavaObject();
...
_vvvvvvvvvvvvvvv5 = new b4a.example.b4xset();
...
_vvvvvvvvvvvvvvv6 = new anywheresoftware.b4a.objects.ActivityWrapper();
 //BA.debugLineNum = 44;BA.debugLine="Public ShowUpIndicator As Boolean = True";
_vvvvvvvvvvvvvvv7 = __c.True;
...
_pi = _vvvvvvvvvvvvv5(_b4xpage);
 //BA.debugLineNum = 211;BA.debugLine="If mStackOfPageIds.Contains(pi.Id) = False Then R";
if (_vvvvvvvvvvvvvvv5._vvvvvvvvvvvv3 /*boolean*/ ((Object)(_pi.Id /*String*/ ))==__c.False) { 
if (true) return "";};
 //BA.debugLineNum = 212;BA.debugLine="If xui.IsB4i And GetTopPage <> pi Then";
if (_vvvv4.getIsB4i() && (_vvvvvvvvvvvvv0()).equals(_pi) == false) { 
...
if (true) return "";
 }else if(_vvvv4.getIsB4i() && _vvvvvvvvvvvvvvv5._getvvvvvv3 /*int*/ ()==1) { 
...
_isclosingtoppage = (_vvvvvvvvvvvvv0()).equals(_pi);
...
if (_vvvv4.getIsB4A() && _vvvvvvvvvvvvvvv5._getvvvvvv3 /*int*/ ()==1) { 
if (true) return "";};
 //BA.debugLineNum = 225;BA.debugLine="mStackOfPageIds.Remove(pi.Id)";
_vvvvvvvvvvvvvvv5._vvvvvvv7 /*String*/ ((Object)(_pi.Id /*String*/ ));
...
if (_vvvv4.getIsB4A()) { 
_vvvvvvvvvvvvvv5(_vvvvvvvvvvvvv0());};
...
public String  _vvvvvvvvvvvv6(b4a.example.b4xpagesmanager._b4xpageinfo _pi) throws Exception{
...
if (_vvvvvvvvvvvvvvv5._getvvvvvv3 /*int*/ ()==1) { 
...
public boolean  _vvvvvvvvvvvv7(b4a.example.b4xpagesmanager._b4xpageinfo _pi) throws Exception{
...
public b4a.example.b4xpagesmanager._b4xpageinfo  _vvvvvvvvvvvv0(Object _b4xpage,String _id,boolean _created,Object _title) throws Exception{
...
public b4a.example.b4xpagesmanager._b4xpageparent  _vvvvvvvvvvvvv1(Object _nativetype) throws Exception{
...
public String  _vvvvvvvvvvvvv2(Object _menu) throws Exception{
b4a.example.b4xpagesmanager._b4xpageinfo _pi = null;
anywheresoftware.b4j.object.JavaObject _jo = null;
b4a.example.b4xpagesmanager._b4amenuitem _mi = null;
...
public String  _vvvvvvvvvvvvv3(b4a.example.b4xpagesmanager._b4xpageinfo _pi) throws Exception{
...
_pi.IsFirst /*boolean*/  = _vvvvvvvvvvvvvvv2._getvvvvvv3 /*int*/ ()==1;
...
_vvvvvvvvvvvvvvv3._vvvvvvvvv4 /*String*/ ((Object)(_pi.Root /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getObject()),(Object)(_pi));
 //BA.debugLineNum = 358;BA.debugLine="LogEvent(pi, \"B4XPage_Created\")";
_vvvvvvvvvvvvvv2(_pi,"B4XPage_Created");
...
public String  _vvvvvvvvvvvvv4(b4a.example.b4xpagesmanager._b4xpageinfo _pi) throws Exception{
...
_pi.Parent /*b4a.example.b4xpagesmanager._b4xpageparent*/  = _vvvvvvvvvvvvv1((Object)(_vvvvvvvvvvvvvvv6.getObject()));
...
public b4a.example.b4xpagesmanager._b4xpageinfo  _vvvvvvvvvvvvv5(Object _page) throws Exception{
b4a.example.b4xpagesmanager._b4xpageinfo _pi = null;
...
{
final anywheresoftware.b4a.BA.IterableList group1 = _vvvvvvvvvvvvvvv2._getvvvvvvvvvvv6 /*anywheresoftware.b4a.objects.collections.List*/ ();
...
if (true) return _vvvvvvvvvvvvv6(_id).B4XPage /*Object*/ ;
 //BA.debugLineNum = 396;BA.debugLine="End Sub";
return null;
}
public b4a.example.b4xpagesmanager._b4xpageinfo  _vvvvvvvvvvvvv6(String _id) throws Exception{
b4a.example.b4xpagesmanager._b4xpageinfo _pi = null;
...
_pi = (b4a.example.b4xpagesmanager._b4xpageinfo)(_vvvvvvvvvvvvvvv2._vvvvv0 /*Object*/ ((Object)(_id.toLowerCase())));
...
__c.LogImpl("98847364","Ids: "+BA.ObjectToString(_vvvvvvvvvvvvvvv2._getvvvvvvvvv3 /*anywheresoftware.b4a.objects.collections.List*/ ()),0);
 };
...
public b4a.example.b4xpagesmanager._b4xpageinfo  _vvvvvvvvvvvvv7(anywheresoftware.b4a.objects.B4XViewWrapper _root) throws Exception{
...
if (true) return (b4a.example.b4xpagesmanager._b4xpageinfo)(_vvvvvvvvvvvvvvv3._vvvvv0 /*Object*/ ((Object)(_root.getObject())));
 //BA.debugLineNum = 409;BA.debugLine="End Sub";
return null;
}
public b4a.example.b4xpagesmanager._b4xpageinfo  _vvvvvvvvvvvvv0() throws Exception{
...
if (_vvvvvvvvvvvvvvv5._getvvvvvv3 /*int*/ ()==0) { 
if (true) return (b4a.example.b4xpagesmanager._b4xpageinfo)(__c.Null);};
 //BA.debugLineNum = 594;BA.debugLine="Return IdToB4XPage.Get(mStackOfPageIds.AsList.Get";
if (true) return (b4a.example.b4xpagesmanager._b4xpageinfo)(_vvvvvvvvvvvvvvv2._vvvvv0 /*Object*/ (_vvvvvvvvvvvvvvv5._vvvvvvvvvvvv2 /*anywheresoftware.b4a.objects.collections.List*/ ().Get((int) (_vvvvvvvvvvvvvvv5._getvvvvvv3 /*int*/ ()-1))));
 //BA.debugLineNum = 595;BA.debugLine="End Sub";
return null;
}
public void  _vvvvvvvvvvvvvv1(b4a.example.b4xpagesmanager._b4xpageinfo _pi) throws Exception{
...
parent._vvvvvvvvvvvvvv2(_pi,"B4XPage_CloseRequest");
...
_nonmainpagewasadded = _vvvvvvvvvvvvvvv2._getvvvvvv3 /*int*/ ()>0;
 //BA.debugLineNum = 81;BA.debugLine="IdToB4XPage.Put(\"~~~~~temp~~~~\", CreateB4XPageInf";
_vvvvvvvvvvvvvvv2._vvvvvvvvv4 /*String*/ ((Object)("~~~~~temp~~~~"),(Object)(_vvvvvvvvvvvv0((Object)(_vvv1),"",__c.False,(Object)(""))));
 //BA.debugLineNum = 82;BA.debugLine="BackgroundStateChanged(True)";
_vvvvvvvvvvvv4(__c.True);
 //BA.debugLineNum = 83;BA.debugLine="IdToB4XPage.Remove(\"~~~~~temp~~~~\")";
_vvvvvvvvvvvvvvv2._vvvvvvv7 /*String*/ ((Object)("~~~~~temp~~~~"));
...
if (_vvvvvvvvvvvvvvvv4==__c.False) { 
...
public String  _vvvvvvvvvvvvvv2(b4a.example.b4xpagesmanager._b4xpageinfo _pi,String _ev) throws Exception{
String _msg = "";
...
if (_vvvvvvvvvvvvvvvv4) { 
 //BA.debugLineNum = 642;BA.debugLine="Dim msg As String = $\"*** ${pi.Id}: ${ev} ${Stac";
_msg = ("*** "+__c.SmartStringFormatter("",(Object)(_pi.Id /*String*/ ))+": "+__c.SmartStringFormatter("",(Object)(_ev))+" "+__c.SmartStringFormatter("",(Object)(_vvvvvvvvvvvvvvvv3))+"");
...
_vvvvvvvvvvvvvv3(_vvvvvvvvvvvvv7((anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(__c.Sender(ba)))),"B4XPage_Resize",new Object[]{(Object)(_w),(Object)(_h)});
 //BA.debugLineNum = 589;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvv3(b4a.example.b4xpagesmanager._b4xpageinfo _targetpage,String _subname,Object[] _params) throws Exception{
int _length = 0;
...
_vvvvvvvvvvvvvv2(_targetpage,_subname);
...
public Object  _vvvvvvvvvvvvvv4(b4a.example.b4xpagesmanager._b4xpageinfo _targetpage,String _subname,Object[] _params) throws Exception{
int _length = 0;
...
_vvvvvvvvvvvvvvv5._vvvvvvvvvvvv1 /*String*/ ((Object)(_pi.Id /*String*/ ));
...
{
final anywheresoftware.b4a.BA.IterableList group8 = _vvvvvvvvvvvvvvv5._vvvvvvvvvvvv2 /*anywheresoftware.b4a.objects.collections.List*/ ();
...
_pagetoremove = _vvvvvvvvvvvvv6(_id);
...
_vvvvvvvvvvvvvvv5._vvvvv7 /*String*/ ();
...
if (_vvvvvvvvvvvvvvvv2>0) { 
 //BA.debugLineNum = 342;BA.debugLine="mMainForm.AddView(pnl, 0, 0, 20dip, 20dip)";
_vvvvvvvvvvvvvvv6.AddView((android.view.View)(_pnl.getObject()),(int) (0),(int) (0),__c.DipToCurrent((int) (20)),__c.DipToCurrent((int) (20)));
 //BA.debugLineNum = 343;BA.debugLine="pnl.SetLayoutAnimated(TransitionAnimationDuratio";
_pnl.SetLayoutAnimated(_vvvvvvvvvvvvvvvv2,(int) (0),(int) (0),__c.PerXToCurrent((float) (100),ba),__c.PerYToCurrent((float) (100),ba));
 }else {
 //BA.debugLineNum = 345;BA.debugLine="mMainForm.AddView(pnl, 0, 0, 100%x, 100%y)";
_vvvvvvvvvvvvvvv6.AddView((android.view.View)(_pnl.getObject()),(int) (0),(int) (0),__c.PerXToCurrent((float) (100),ba),__c.PerYToCurrent((float) (100),ba));
 };
...
_vvvvvvvvvvvvvv3(_pi,"B4XPage_Appear",(Object[])(__c.Null));
 };
 };
 //BA.debugLineNum = 298;BA.debugLine="If ShowUpIndicator And ActionBar.IsInitialized Th";
if (_vvvvvvvvvvvvvvv7 && _vvvvvvvvvvvvvvv0.IsInitialized()) { 
 //BA.debugLineNum = 299;BA.debugLine="ActionBar.RunMethod(\"setDisplayHomeAsUpEnabled\",";
_vvvvvvvvvvvvvvv0.RunMethod("setDisplayHomeAsUpEnabled",new Object[]{(Object)(_vvvvvvvvvvvvvvv5._getvvvvvv3 /*int*/ ()>1)});
 };
...
public String  _vvvvvvvvvvvvvv7() throws Exception{
b4a.example.b4xpagesmanager._b4xpageinfo _pi = null;
...
_vvvvvvvvvvvvvv4(_pi,"B4XPage_Disappear",(Object[])(__c.Null));
 };
 };
...
_vvvvvvvvvvvvvvv4.RunMethod("invalidateOptionsMenu",(Object[])(__c.Null));
 //BA.debugLineNum = 492;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvv1() throws Exception{
...
{
final anywheresoftware.b4a.BA.IterableList group5 = _vvvvvvvvvvvvvvv5._vvvvvvvvvvvv2 /*anywheresoftware.b4a.objects.collections.List*/ ();
final int groupLen5 = group5.getSize()
;int index5 = 0;
;
for (; index5 < groupLen5;index5++){
...
_vvvvvvvvvvvvvvvv3 = _sb.ToString();

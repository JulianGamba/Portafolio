...
vis = vis | (ejercicio1.mostCurrent != null);
vis = vis | (ejercicio2.mostCurrent != null);
vis = vis | (ejercicio3.mostCurrent != null);
vis = vis | (ejercicio4.mostCurrent != null);
vis = vis | (ejercicio5.mostCurrent != null);
vis = vis | (ejercicio6.mostCurrent != null);
return vis;}
...
public static String  _button1_click() throws Exception{
 ...
 //BA.debugLineNum = 41;BA.debugLine="StartActivity(\"ejercicio1\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("ejercicio1"));
 //BA.debugLineNum = 42;BA.debugLine="End Sub";
return "";
}
public static String  _button2_click() throws Exception{
 //BA.debugLineNum = 44;BA.debugLine="Private Sub Button2_Click";
 //BA.debugLineNum = 45;BA.debugLine="StartActivity(\"ejercicio2\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("ejercicio2"));
 //BA.debugLineNum = 46;BA.debugLine="End Sub";
return "";
}
public static String  _button3_click() throws Exception{
 //BA.debugLineNum = 48;BA.debugLine="Private Sub Button3_Click";
 //BA.debugLineNum = 49;BA.debugLine="StartActivity(\"ejercicio3\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("ejercicio3"));
 //BA.debugLineNum = 50;BA.debugLine="End Sub";
return "";
}
public static String  _button4_click() throws Exception{
 //BA.debugLineNum = 52;BA.debugLine="Private Sub Button4_Click";
 //BA.debugLineNum = 53;BA.debugLine="StartActivity(\"ejercicio4\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("ejercicio4"));
 //BA.debugLineNum = 54;BA.debugLine="End Sub";
return "";
}
public static String  _button5_click() throws Exception{
 //BA.debugLineNum = 56;BA.debugLine="Private Sub Button5_Click";
 //BA.debugLineNum = 57;BA.debugLine="StartActivity(\"ejercicio5\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("ejercicio5"));
 //BA.debugLineNum = 58;BA.debugLine="End Sub";
return "";
}
public static String  _button6_click() throws Exception{
 //BA.debugLineNum = 60;BA.debugLine="Private Sub Button6_Click";
 //BA.debugLineNum = 61;BA.debugLine="StartActivity(\"ejercicio6\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("ejercicio6"));
...
ejercicio1._process_globals();
starter._process_globals();
ejercicio2._process_globals();
ejercicio3._process_globals();
ejercicio4._process_globals();
ejercicio5._process_globals();
ejercicio6._process_globals();

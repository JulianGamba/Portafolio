...
_vvvvv5._vv3 /*b4a.example.b4xpagesmanager*/ (getActivityBA())._activity_actionbarhomeclick /*String*/ ();
...
if (true) return _vvvvv5._vv3 /*b4a.example.b4xpagesmanager*/ (getActivityBA())._activity_keypress /*boolean*/ (_keycode);
...
_vvvvv5._vv3 /*b4a.example.b4xpagesmanager*/ (getActivityBA())._activity_pause /*String*/ ();
...
_vvvvv5._vv3 /*b4a.example.b4xpagesmanager*/ (getActivityBA())._vvvvvvvvvvvvvv3 /*String*/ (_vvvvv5._vv3 /*b4a.example.b4xpagesmanager*/ (getActivityBA())._vvvvvvvvvvvvv0 /*b4a.example.b4xpagesmanager._b4xpageinfo*/ (),"B4XPage_PermissionResult",new Object[]{(Object)(_permission),(Object)(_result)});
...
_vvvvv5._vv3 /*b4a.example.b4xpagesmanager*/ (getActivityBA())._activity_resume /*String*/ ();
...
_vvvvv5._vv3 /*b4a.example.b4xpagesmanager*/ (getActivityBA())._vvvvvvvvvvvvv2 /*String*/ (_menu);
...
_vvvvv5._vv3 /*b4a.example.b4xpagesmanager*/ (getActivityBA())._mainform_resize /*String*/ (_width,_height);
